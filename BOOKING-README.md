...
- Successful submissions create a **Table Booking** entry, send a verification link to the customer by email (and SMS via seven.io when configured), and notify the admin/business email configured under *PixelForge Options* (falls back to the site admin email).
