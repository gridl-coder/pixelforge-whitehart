...
<section class="stage-menu">
  ...
  <div class="boxed-container" style="max-width: 900px; margin: 0 auto;">
    ...
    <g data-name="Layer 1">
      ...
      <p>
        Our Main Menu is served <strong>Mon/Tue/Thur/Fri/Sat: 10:00 - 15:00</strong><br/>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="menu-section menu-section--left">
              ...
              <p><small>Breakfast comes with a choice of Toast, Fried Bread or Bread &amp;
                  Butter.</small>
              </p>
              <div class="menu-item">
                <h4>Small Breakfast<span class="price">£7.95</span></h4>
                <p>Sausage, Bacon, Egg, Tomatoes, Mushrooms, Hash Brown, Beans.</p>
              </div>

              <div class="menu-item">
                <h4>Large Breakfast<span class="price">£10.95</span></h4>
                <p>2 Sausages, 2 Bacon, 2 Eggs, Tomatoes, Mushrooms, Hash Browns, Beans, Hogs/Black
                  Pudding.</p>
              </div>
            ...
            <div class="menu-section menu-section--left">
              ...
              <h3>Sandwiches/Toasted Sandwiches</h3>
          ...
          <div class="col-md-6">
            <div class=" menu-section menu-section--right">
              <h3>Burgers</h3>
              <p><small>Served with Chips, Salad & Coleslaw.</small>
              </p>
              <div class="menu-item">
                <h4>Chicken Burger <span class="price">£11.95</span></h4>
                <p>Chicken Burger with Bacon, Cheese, Hash Brown & BBQ Sauce.</p>
              </div>

              <div class="menu-item">
                <h4>4oz Cheese Burger <span class="price">£9.95</span></h4>
                <p>A 4oz Beef Burger topped with Cheese.<br/>
                  <small><strong>Add Bacon - £1 | Double Up - £1.50</strong></small>
                </p>
              </div>

              <div class="menu-item">
                <h4>Veggie Burger <span class="price">£9.95</span></h4>
              </div>
            </div>
            ...
            <div class=" menu-section menu-section--right">
              <h3>Sides</h3>
              <div class="menu-item">
                <h4>Onion Rings <span class="price">£2.95</span></h4>
                <h4>Chips <span class="price">£2.95</span></h4>
                <h4>Cheesey Chips <span class="price">£2.95</span></h4>
              </div>
            </div>
            <div class=" menu-section menu-section--right">
              ...
              <p><strong>Allergen Information:</strong> Our kitchen deals with a variety of allergens
                so
                we are unable to cater for people with specific allergies or special dietry
                requirements.</p>

              <p class="text-end">
                <a href="<?= get_template_directory_uri(); ?>/resources/images/hart-main-1.png"
                   target="_blank" class="btn btn-primary btn-lg">Download Menu</a></p>
