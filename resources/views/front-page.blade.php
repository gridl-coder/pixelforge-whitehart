    ...
    <section class="global-contact">
      ...
      <div class="boxed-container mb-4">
        ...
        <div class="boxed-content-item">
          ...
          <p class="lead" style="max-width: 700px; display: block; margin: 30px auto">If you have questions or if you
          ...
          <div class="row">
            ...
            <div class="col-md-4 address">
              <a
                ...
                target="_blank">
                        <span class="icon">
<svg fill="#cbba57" width="60" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.0.0-alpha3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) --><path d="M265.4 233.4c-12.5 12.5-12.5 32.75 0 45.25s32.75 12.5 45.25 0s12.5-32.77 0-45.25C298.1 220.9 277.9 220.9 265.4 233.4zM288 0C146.6 0 32 114.6 32 256c0 141.4 114.6 256 256 256s256-114.6 256-256C544 114.6 429.4 0 288 0zM414.1 156l-65.97 144.4c-2.719 5.969-9.778 13.02-15.75 15.76l-144.3 65.97c-16.66 7.609-33.81-9.547-26.19-26.2l65.97-144.3c2.719-5.984 9.781-13.05 15.78-15.78l144.3-65.97C404.6 122.3 421.8 139.4 414.1 156z"/></svg>
                        </span><br><br>
