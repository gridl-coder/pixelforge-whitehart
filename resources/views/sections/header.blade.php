      ...
      <div class="quick-links col-12 col-md-3">
        ...
        <ul>
          @if (!empty($companyProfile['phone']))
            <li class="phone">
              <a href="tel:{{ $companyProfile['phone']['tel'] }}" aria-label="Call {{ $companyProfile['phone']['display'] }}">
                <i class="fa-solid fa-circle-phone-hangup" aria-hidden="true">
          ...
          @if (!empty($companyProfile['email']))
            <li class="email">
              <a href="mailto:{{ antispambot($companyProfile['email']) }}" aria-label="Email {{ antispambot($companyProfile['email']) }}">
                <i class="fa-solid fa-circle-envelope" aria-hidden="true">
          ...
          @if (!empty($companyProfile['mapUrl']) && !empty($companyProfile['address']))
            <li class="directions">
              <a href="{{ esc_url($companyProfile['mapUrl']) }}" target="_blank" rel="noopener" aria-label="Get directions to {{ $companyProfile['name'] }}">
          ...
          @elseif (!empty($companyProfile['address']))
            <li class="directions">
              <a href="{{ esc_url($companyProfile['mapUrl']) }}" target="_blank" rel="noopener" aria-label="Get directions to {{ $companyProfile['address'] }}">
                <i class="fa-solid fa-compass" aria-hidden="true">
